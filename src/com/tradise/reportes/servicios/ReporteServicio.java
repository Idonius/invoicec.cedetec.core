   ...
   public FacCabDocumento buscarDatosCabDocumentos(String Ruc, String codEst, String codPuntEm, String codDoc, String secuencial)
   {
     ...
     try {
       ...
       while (rs.next())
       {
         ...
         cabDocumento.setFechaEmisionDocSustento(rs.getString("fechaEmisionDocSustento"));
...
public List<FacDetDocumento> buscarDatosDetallesDocumentos(com.cimait.invoicec.bean.Emisor emite)
   {

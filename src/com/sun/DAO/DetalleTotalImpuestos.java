...
public class DetalleTotalImpuestos {
	
	private int codTotalImpuestos;
	private int codPorcentImp;
	private double tarifaImp;
	private double baseImponibleImp;
	...
	public double getBaseImponibleImp() {
		return baseImponibleImp;
	}
	public void setBaseImponibleImp(double baseImponibleImp) {

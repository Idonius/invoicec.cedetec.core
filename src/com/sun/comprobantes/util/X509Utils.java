...
import com.cimait.invoicec.sri.xades.FirmasGenericasXAdES;
import com.cimait.invoicec.sri.xades.ValidacionBasica;
...
public class X509Utils
{
    ...
    throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateExpiredException, CertificateNotYetValidException, CertificateException
  {
    ...
    while (nombres.hasMoreElements()) {
      ...
      //TODO: no validar por tipo de token .
  ...
  public static synchronized String firmaValidaArchivo(File archivo, String dirPathSalida, String rucEmisor, String tokenID, String password, String rutaCertificado)
  {
    ...
    try
    {
      ...
      if  (((jreVersion.indexOf("1.6") == 0) || (jreVersion.indexOf("1.7") == 0)))
      {
  ...
  public static String obtenerOidAutoridad(X509Certificate certificado)
  {
    ...
    if (nombreAutoridad.equals(AutoridadesCertificantes.BANCO_CENTRAL.getCn()))
      ...
      //TODO: Eliminar siguene linea solo para prueba.
    } else if (nombreAutoridad.equals("Enrique Almonte")){
    	oidRaiz = AutoridadesCertificantes.BANCO_CENTRAL.getOid();
    }

...
@IdClass(FacDetImpuestosEntityPK.class)
public class FacDetImpuestosEntity {
    private String ruc;
    ...
    public int getDetSecuencial() {
        return detSecuencial;
    }

    public void setDetSecuencial(int detSecuencial) {
    ...
    public boolean equals(Object o) {
        ...
        FacDetImpuestosEntity that = (FacDetImpuestosEntity) o;

        if (codImpuesto != that.codImpuesto) return false;
        if (detSecuencial != that.detSecuencial) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + detSecuencial;
